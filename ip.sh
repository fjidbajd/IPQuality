...
echo "bash <(curl -s https://raw.githubusercontent.com/fjidbajd/IPQuality/main/ref/upgrade_bash.sh)"
exit 0
fi
}
check_bash
...
show_ad(){
asponsor=$(curl -sL --max-time 5 "https://raw.githubusercontent.com/fjidbajd/IPQuality/main/ref/sponsor.ans")
aad1=$(curl -sL --max-time 5 "https://raw.githubusercontent.com/fjidbajd/IPQuality/main/ref/ad1.ans")
echo -e "$asponsor"
echo -e "$aad1"
}
check_IP(){
